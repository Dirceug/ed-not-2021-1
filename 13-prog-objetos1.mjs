...
/*
    A forma tradicional com que o JavaScript lida com objetos não permite o controle sobre uma criação nem sobre o seu conteúdo. Os objetos funcionam baseados estritamente no "Controle de qualidade" feito pelo usuário programador.
*/
