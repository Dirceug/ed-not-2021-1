...
export class DoublyLinkedList{
    ...
    remove(pos)
    {
        ...
        if(pos === 0)
        {
            ...
            //4º Caso: remoção em posilção intermediária
            else
            {
...
let removed = lista.removeHead()    //Remoção do inicio
console.log({removed})
console.log(lista.print())
console.log(lista.printReverse())
console.log("")

removed = lista.removeTail()    //Remoção do inicio
console.log({removed})
console.log(lista.print())
console.log(lista.printReverse())
console.log("")
...
removed = lista.remove(2)    //Remoção do inicio
console.log({removed})
console.log(lista.print())
console.log(lista.printReverse())
console.log("")
